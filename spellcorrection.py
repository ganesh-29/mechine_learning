...
def correction():
    ...
    # Insert the corrected word in the text entry box
...
if __name__ == "__main__":
    ...
    # Create a Correction Button and attach it with the correction function
    button1 = Button(root, text="Correction", bg="red", fg="black", command=correction)
    button1.grid(row=2, column=1)

    # Create a Clear Button and attach it with the clearAll function
